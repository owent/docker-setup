...
ROUTER_LOCAL_LAN_INTERFACE='{ lo, br0, enp2s0 , vlan0, tun-vbox }'
...
ROUTER_INTERNAL_SERVICE_PRIVATE_PORT_TCP="53,80,139,443,445,853,5432,6543,6800,8080,8375"
ROUTER_INTERNAL_SERVICE_PUBLIC_PORT_TCP="6096,6349,6443,6881,6882,6883,8371,8372,8373,36000"
ROUTER_INTERNAL_SERVICE_PRIVATE_PORT_UDP="53,67,68,80,137,138,443,547,1900,3478,6800,8080,8375,10001"
...
ROUTER_NET_LOCAL_ENABLE_VBOX=0
