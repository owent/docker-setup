...
ROUTER_INTERNAL_SERVICE_PRIVATE_PORT_TCP="53,68,80,139,443,445,853,5432,6401,6402,6403,6404,6442,6543,6800,8080,8375,8376,8377,8853"
ROUTER_INTERNAL_SERVICE_PUBLIC_PORT_TCP="6096,6349,6391,6392,6393,6443,6636,6881,6882,6883,8371,8372,8373,36000"
ROUTER_INTERNAL_SERVICE_PRIVATE_PORT_UDP="53,67,68,80,137,138,443,546,547,784,853,1900,3478,6402,6403,6404,6442,6800,8080,8375,8376,8377,8853,10001"
...
#   - nextcloud/router-caddy(https): 6443
#   - router-caddy(http): 6442
#   - aria2: 6881-6883
#   - v2ray: 6371-6373
#   - AdGuard Home: 6391-6393
#   - Kea DHCP: 67, 547, 6402(DHCP4 HA), 6403(DHCP6 HA)
#   - Kea Ctrl AGENT: 6404
#   - traefik web port: 6401
#   - DNS: 53, 853
#   - NTP: 123
...
VBOX_TUN_PROXY_WHITELIST_TABLE_ID=1822
...
# If we use DHCPv6 and NAT66 we can keep NAT6
ROUTER_NAT_SETUP_WITH_NAT66=0

ROUTER_SDWAN_WITH_IPV6=1

ACMESH_SSL_DIR=$ROUTER_DATA_ROOT_DIR/acme.sh/ssl
HOME_CERTS_SSL_DIR=$ROUTER_DATA_ROOT_DIR/home-certs/website-ca-crl
...
ONLYOFFICE_DB_PORT=$POSTGRES_PORT                       # -e DB_PORT=$ONLYOFFICE_DB_PORT
