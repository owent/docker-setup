...
LLM_CHATGPT_NEXT_WEB_BASE_URL=https://owent-one-api.imwe.chat
...
# LLM_CHATGPT_NEXT_WEB_GOOGLE_URL=
...
LLM_CHATGPT_NEXT_WEB_CUSTOM_MODELS=-all,+gpt-4-32k,+gpt-4-turbo,+gpt-3.5-turbo-16k,+gpt-3.5-turbo
