...
# LLM_OPENWEBUI_OPENAI_API_KEY=sk-
# LLM_OPENWEBUI_OPENAI_API_BASE_URL=https://litellm.imwe.chat

# LLM_OPENWEBUI_ENABLE_IMAGE_GENERATION=true
# LLM_OPENWEBUI_IMAGE_GENERATION_ENGINE=openai
# LLM_OPENWEBUI_IMAGES_OPENAI_API_KEY=
# LLM_OPENWEBUI_IMAGES_OPENAI_API_BASE_URL=https://owent-se.openai.azure.com
# LLM_OPENWEBUI_IMAGE_GENERATION_MODEL=dall-e3
