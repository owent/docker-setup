...
nft add rule ip nat POSTROUTING meta l4proto tcp ip saddr @LOCAL_IPV4 ip daddr != @LOCAL_IPV4 ip daddr != '{ 172.20.1.1/24 }' counter packets 0 bytes 0 masquerade to :10000-65535
