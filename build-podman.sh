...
PODMAN_OSTREE_VERSION=v2024.9
# PODMAN_GOLANG_URL=https://dl.google.com/go/go1.23.4.linux-amd64.tar.gz ;
PODMAN_GOLANG_URL=https://mirrors.ustc.edu.cn/golang/go1.23.4.linux-amd64.tar.gz
PODMAN_CONMON_VERSION=v2.1.12
PODMAN_RUNC_VERSION=v1.2.3
PODMAN_CNI_PLUGINS_VERSION=v1.6.1 # For rootful network
PODMAN_LIBPOD_VERSION=v5.3.1
PODMAN_SLIRP4NETNS_VERSION=v1.3.1 # For rootless network
PODMAN_FUSE_OVERLAYFS=v1.14
